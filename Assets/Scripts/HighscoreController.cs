...
public class HighscoreController : MonoBehaviour {
	...
	[SerializeField] private TMP_Text policeScore;
	[SerializeField] private TMP_Text taxiScore;
	...
	private void Update() {
		if (GameManager.IsGameOver) {
			...
			System.TimeSpan pScore = score.policeScore;
			System.TimeSpan jScore = score.taxiScore;
			...
			policeScore.text = pScore.Hours.ToString("00") + ":" +
				pScore.Minutes.ToString("00") + ":" +
				pScore.Seconds.ToString("00") + "." +
				pScore.Milliseconds/100;

			taxiScore.text = jScore.Hours.ToString("00") + ":" +
